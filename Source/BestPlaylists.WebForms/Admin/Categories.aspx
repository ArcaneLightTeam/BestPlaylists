    ...
    <asp:ListView runat="server" ID="ListViewCategories" ItemType="BestPlaylists.Data.Models.Category" SelectMethod="ListViewCategories_GetData" DeleteMethod="ListViewCategories_DeleteItem" UpdateMethod="ListViewCategories_UpdateItem" DataKeyNames="ID" InsertMethod="ListViewCategories_InsertItem" InsertItemPosition="LastItem">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td class="text-center">
                    <asp:LinkButton runat="server" ID="LinkButtonEdit" Text="Edit" CommandName="Edit" CssClass="btn btn-primary col-sm-6"/>
                    <asp:LinkButton runat="server" ID="LinkButtonDelete" Text="Delete" CommandName="Delete" CssClass="btn btn-danger col-sm-6"/>
                </td>
            </tr>
        </ItemTemplate>
        <EditItemTemplate>
        ...
        <InsertItemTemplate>
            <tr>
                ...
                <td class="text-center"> 
                    <asp:LinkButton runat="server" ID="LinkButton3" Text="Insert" CommandName="Insert" CssClass="btn btn-success col-sm-6"/>
                    <asp:LinkButton runat="server" ID="LinkButton4" Text="Cancel" CommandName="Cancel" CssClass="btn btn-primary col-sm-6"/>
                </td>
            </tr>
        </InsertItemTemplate>
    </asp:ListView>
